...
install rootdir="" prefix="/usr/local": build
    ...
    {{ just }} rootdir="{{ rootdir }}" prefix="{{ prefix }}" armillary/install
...
uninstall rootdir="" prefix="/usr/local":
    ...
    {{ just }} rootdir="{{ rootdir }}" prefix="{{ prefix }}" armillary/uninstall
